...
// Motors setup
var panMotor = motor.setup(cfg.panMotor[0], cfg.panMotor[1], cfg.panMotor[2]);
var tiltMotor = motor.setup(cfg.tiltMotor[0], cfg.tiltMotor[1], cfg.panMotor[2]);



exports.grabFrames = (onFrame) => {

	console.log('Open video source ...', cfg.videoSourceIndex);
